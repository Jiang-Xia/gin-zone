<template>
  <pageConfig title="demo">
    <view class="container">
      <t-button block type="primary" @click="bool = !bool">表情包</t-button>
      <view ref="confirm" class="emoji-list" v-show="bool">
        <view class="emoji-list__content" v-show="bool">
          <z-paging
            ref="paging"
            use-virtual-list
            :force-close-inner-list="true"
            style="height: 300rpx; position: absolute; bottom: 0; top: inherit"
